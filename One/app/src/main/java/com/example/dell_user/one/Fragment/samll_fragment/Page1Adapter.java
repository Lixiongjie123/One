...
//
//    @Override
//    public ReadingRecyclerviewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
//        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.card, parent, false);
//        final ReadingRecyclerviewAdapter.ViewHolder holder = new ReadingRecyclerviewAdapter.ViewHolder(view);
//        return holder;
//    }
//
//
