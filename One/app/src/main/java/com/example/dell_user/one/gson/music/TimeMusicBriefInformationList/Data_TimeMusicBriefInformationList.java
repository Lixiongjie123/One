...
// 备注：photo数组和tag_list数组都用的Sting，
// title为电影标题，detailcover为顶部图片，video为电影预告片地址。keywords为底下的五个关键词，info为影片制作相关信息，charge_edt为责任编辑，
// releasetime、scoretime、maketime、last_update_date为时间，格式(2016-10-21 00:00:00)，photo为剧照，servertime为时间戳
